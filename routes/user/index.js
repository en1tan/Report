...
const deactivateAccount = require('../../controllers/auth/deactivateAccount');
...
router.post('/deactivate', auth(true), deactivateAccount.deactivate);
router.put('/cancel-deactivation', deactivateAccount.cancelDeactivation);
